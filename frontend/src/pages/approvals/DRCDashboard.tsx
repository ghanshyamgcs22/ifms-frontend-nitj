...
// â”€â”€ Reusable split button â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
const DRCDashboard = () => {
  ...
  const actionBtnLabel = () => {
    if (pendingAction === "forward")  return "Forward to Director âž¡";
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 mt-0.5">
                ...
                <span className="text-slate-400 font-mono text-[11px]">
                  DA â†’ AR â†’ DR â†’ DRC Office â†’ DRC (R&C) â†’ <strong className="text-indigo-600">DRC</strong> â†’ Director
                </span>
              </p>
            </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <Textarea
                    placeholder={
                      ...
                      : pendingAction === "sendback" ? "Reason for returning to DRC (R&C)â€¦"
                      : "Forwarding notes (optional)â€¦"
                    }
      ...
      <TableBody>
        {requests.map(r => (
          <TableRow key={r.id} className={`border-b border-slate-100 hover:bg-slate-50/50 ${canAct(r) ? "bg-indigo-50/40" : ""}`}>
            ...
            <TableCell className="text-xs px-3 text-slate-500 max-w-[100px] truncate italic">{(r[remarksField] as string) || "â€”"}</TableCell>
