...
// âœ… Re-upload keeps the SAME file number as the original â€” no new number generated
...
const QueryResponsePage = () => {
  ...
  // â”€â”€ New file state â€” NO file number generation â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  const handleNewFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setNewFile(file);
    // âœ… No file number generation â€” the existing fileNumber is reused as-is
  };
    ...
    try {
      ...
      const res = await fetch(`${API}/resolve-query.php`, {
        ...
        body: JSON.stringify({
          ...
          // âœ… Always send the EXISTING file number â€” never a new one
  ...
  if (loading) return (
    <Layout>
      <div className="flex items-center justify-center min-h-screen gap-3">
        ...
        <p className="text-slate-500 text-sm">Loading requestâ€¦</p>
      </div>
    </Layout>
  );
      ...
      <div className="max-w-3xl mx-auto px-6 py-8 space-y-6">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500 mt-0.5">
            {request.fileNumber && <><strong>File No:</strong> {request.fileNumber} &nbsp;Â·&nbsp;</>}
        ...
        <div className="grid grid-cols-2 gap-3 p-4 bg-blue-50 border border-blue-200 rounded-xl text-sm">
          {[
            ...
            ["Amount",  `â‚¹${(request.amount / 100000).toFixed(2)}L`],
          ...
          <CardContent className="px-5 py-4 space-y-4">
            ...
            {showPdfViewer && pdfUrl && (
              <div className="border border-slate-300 rounded-xl overflow-hidden shadow-md">
                <div className="flex items-center justify-between px-4 py-2 bg-slate-100 border-b border-slate-200">
                  <p className="text-xs font-semibold text-slate-700">ðŸ“„ Quotation Preview</p>
                  <div className="flex items-center gap-3">
                    ...
                    <button type="button" onClick={() => setShowPdf(false)}
                      className="text-xs text-slate-500 hover:text-slate-800">âœ• Close</button>
                  </div>
                </div>
            ...
            <div className="border border-dashed border-slate-300 rounded-lg p-4 space-y-3">
              ...
              <p className="text-xs text-slate-400">
                ...
                be kept â€” the approval certificate will not change its reference.
              </p>
              ...
              {!newFile ? (
                ...
                <div className="space-y-2">
                  ...
                  {/* File number notice â€” shows existing number, read-only */}
                  {request.fileNumber && (
            ...
            <CardContent className="pt-6 space-y-5">
              ...
              <div className="border-t border-slate-200 pt-5 space-y-1.5">
                ...
                <Textarea
                  ...
                  placeholder={`Explain how you've addressed the query raised by ${q?.raisedByLabel || "the reviewer"}â€¦`}
