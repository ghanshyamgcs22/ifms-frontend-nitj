...
const fmtINR = (n: number) =>
  "â‚¹" + parseFloat(String(n || 0)).toLocaleString("en-IN", { maximumFractionDigits: 0 });
...
const ApprovalCertificate = () => {
  ...
  if (loading) return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 gap-3">
      ...
      <p className="text-gray-500 text-sm font-medium">Loading approval certificateâ€¦</p>
    </div>
  );
  ...
  return (
    <>
      {/* Screen controls â€” hidden on print */}
        ...
        >
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "11pt" }}>
            <tbody>
              ...
              {/* Row 2 â€” Name of Indentor & Department */}
              <TableRow num="2." label="Name of Indentor & Department" value={
                <span>{data.piName}{data.department && <>, {data.department}</>}</span>
              } />

              {/* Row 3 â€” Completion Date */}
              <TableRow num="3." label="Completion Date of Project" value={data.projectEndDate || "â€”"} />
              ...
              {/* Row 5 â€” Material */}
              <TableRow num="5." label={<span>Name of the Material to be<br />Purchased &amp; Qty.</span>} value={data.material || data.purpose || "â€”"} />

              {/* Row 6 â€” Total amount estimated */}
