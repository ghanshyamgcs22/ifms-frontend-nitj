...
const DRCOfficeDashboard = () => {
  ...
  const fetchRequests = async () => {
    try {
      setLoading(true);
      const r1 = await fetch(`${import.meta.env.VITE_API_URL}/get-requests-by-stage.php?stage=drc_office&type=pending&summary=1&limit=50`);
      const d1 = await r1.json(); setPendingRequests(d1.data || []);
      const r2 = await fetch(`${import.meta.env.VITE_API_URL}/get-requests-by-stage.php?stage=drc_office&type=completed&summary=1&limit=50`);
